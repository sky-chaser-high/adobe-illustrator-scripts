/* ===============================================================================================================================================
   ...
   Description
   This script is equivalent to Visual Studio Code's "Insert Line Below". (Cmd/Ctrl + Enter)
   Both point and area types are supported.

   Usage
   Move the cursor to the line above you want to add a line, run this script from File > Scripts > Other Script...

/* ===============================================================================================================================================
   navigateToLastArtboard

   Description
   This script navigates to the last artboard while maintaining the view position and zoom factor of the artboard.
...
function main() {
    ...
    var last = artboards.length - 1;
    artboards.setActiveArtboardIndex(last);

    setViewPosition(view, artboards[last], distance);
}

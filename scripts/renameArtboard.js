/* ===============================================================================================================================================
   ...
   Notes
   A warning is issued if the number of lines in the text field does not match the number of artboards.
...
function showDialog(artboards) {
    ...
    edittext1.onChanging = function() {
        ...
        var contents = texts.length + ' ' + ui.lines + '/ ' + artboards.length + ' ' + ui.artboards;
    ...
    checkbox1.onClick = function() {
        if (checkbox1.value) {
            edittext2.text = artboards.length;
        }
        else {
            edittext2.text = '1';
        }
...
function localizeUI() {
    return {
        ...
        message: {
            en: 'The number of lines in the text field does not match the number of artboards.',
            ja: 'テキストフィールドの行数とアートボード数が一致していません。'
        }
    };
}

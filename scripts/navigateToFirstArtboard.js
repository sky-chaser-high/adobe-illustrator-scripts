/* ===============================================================================================================================================
   navigateToFirstArtboard

   Description
   This script navigates to the first artboard while maintaining the view position and zoom factor of the artboard.
...
function main() {
    ...
    var first = 0;
    artboards.setActiveArtboardIndex(first);

    setViewPosition(view, artboards[first], distance);
}
